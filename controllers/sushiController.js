...
exports.sushi_create_post = [
  body("name", "Name is required").trim().isLength({ min: 2 }).escape(),
...
exports.sushi_update_get = (req, res) => {
  res.send("get da sushi update");
};

exports.sushi_update_post = (req, res) => {
  res.send("Update the sushi");
};
